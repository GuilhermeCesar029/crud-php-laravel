<div class="input-field">
  <!-- verificando se existe a variavel $registro, se existir coloca ela no campo titulo, se nao ela fica vazia -->
...
<div class="file-field  input-field">
  ...
  <div class="file-path-wrapper">
    <input class="file-path validate" type="text" placeholder="A foto é Obrigatoria!">
  </div>
</div>
